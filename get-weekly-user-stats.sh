...
until ./weekly-user-activity.py org.fedoraproject.prod.infragit.receive; do sleep 5; done
...
until ./weekly-user-activity.py io.pagure.prod.pagure.issue.new; do sleep 5; done
until ./weekly-user-activity.py org.fedoraproject.prod.fedbadges.badge.award; do sleep 5; done
